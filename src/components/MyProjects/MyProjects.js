  ...
  return (
    <section className='projects section' id='projects'>
      ...
      <ul className='projects__container'>
        <ProjectCard imagePath={howLearnImage} projectName='How-to-learn' projectLink='https://github.com/aloe-99/how-to-learn' />
        <ProjectCard imagePath={russianTravelImage} projectName='Russian-travel' projectLink='https://aloe-99.github.io/russian-travel/' />
        <ProjectCard imagePath={mestoImage} projectName='Mesto' projectLink='https://github.com/aloe-99/react-mesto-api-full' />
